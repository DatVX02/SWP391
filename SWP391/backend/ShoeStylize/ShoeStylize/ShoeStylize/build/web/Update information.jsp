...
<head>
    ...
    <link rel="stylesheet" href="CSS\Update information.css">
</head>
    ...
    <div class="information_left">
        ...
        <div class="information_right">
            ...
            <form action="" method=""> 
                ...
                <a href="../Profile/Account information.jsp"><button
                        style="border-radius: 20px; background-color: #EBAA5D; margin-top: 10px;">Submit </button></a>
            </form>
        </div>
