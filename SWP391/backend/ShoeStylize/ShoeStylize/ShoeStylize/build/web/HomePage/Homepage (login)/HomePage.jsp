...
<head>
    ...
    <link rel="stylesheet" href="../Homepage (login)/HomePage.css">
    <!--Bootstrap CSS-->
...
<body>
    ...
    <!-- <div style="text-align: right; transform: translateX(160px); margin-top: 20px; ">
        <a href="../../HomeDes/HomeDes.jsp">
            <button style="background: #FF9900; font-weight: bold; padding: 5px 10px; border: 0.5px ">Create New
                Shoes</button>
        </a>
    </div> -->
    <!-- Category -->
