...
public class MainController extends HttpServlet {
    ...
    private static final String PROADDBLOGCONTROLLER = "ProAddBlogController";
    private static final String SEARCHBLOGCONTROLLER = "SearchBlogController";
    private static final String PROSEARCHBLOGCONTROLLER = "ProSearchBlogController";
        ...
        try {
            switch (button) {
                ...
                case "Update":
                    ...
                    break;
                case "Add Blog":
                    url = ADDBLOGCONTROLLER;
                    break;
                case "Post":
                    url = PROADDBLOGCONTROLLER;
                    break;
                case "Find Blog":
                    url = SEARCHBLOGCONTROLLER;
                    break;
                case "Title Search":
                    url = PROSEARCHBLOGCONTROLLER;
                    break;
                case "Search":
