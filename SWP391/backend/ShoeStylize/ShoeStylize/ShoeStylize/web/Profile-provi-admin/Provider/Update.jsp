...
<html>
    <head>
        ...
        <link href="Account information.css" rel="stylesheet" type="text/css"/>
        <!--Bootstrap CSS-->
    ...
    <body>
        ...
        <div class="information_right">
            ...
            <form action="" method="">
                ...
                <a href="Submit.jsp"><button style="border-radius: 20px; background-color: #EBAA5D; margin-top: 20px; margin-bottom: 15px">Update</button></a>
        </div>
